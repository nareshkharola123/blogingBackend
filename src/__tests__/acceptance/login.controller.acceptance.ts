...
import {TrendsTalksApplication} from '../..';
import {setupApplication} from './test-helper';

import {RoleType} from '../../modules/roles/role.enum';
import {UserRepository} from '../../modules/user/repositories/user.repository';
import {AuthClientRepository} from '../../modules/auth/repositories/auth-client.repository';
import {RoleRepository} from '../../modules/roles/repositories/role.repository';
import {TenantRepository} from '../../modules/tenant/repositories/tenant.repository';
import {UserTenantRepository} from '../../modules/user-tenants/repositories/user-tenant.repository';
import {TenantType} from '../../modules/tenant/tenant-type.enum';

describe('Login Controller', () => {
  let app: TrendsTalksApplication;
  let client: Client;
